...
import { User, LogOut, Settings, Palette, Home, PlusCircle, Compass } from 'lucide-react'; // Removed Zap icon
...
const Navigation: React.FC = () => {
  ...
  const navItems = [
    ...
    { path: '/canvas', label: 'Create', icon: <PlusCircle className="w-4 h-4" /> },
