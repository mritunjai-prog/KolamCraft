...
import { Mail, Lock, User, Eye, EyeOff, Palette, Check, Feather, BookOpen, Award } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-pink-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
          ...
          <CardContent>
            ...
            <div className="mt-4 p-3 bg-blue-50 rounded-lg">
              <p className="text-xs text-blue-700">
                <strong>Privacy Notice:</strong> KolamCraft is not meant for collecting PII or securing sensitive data. 
                We're focused on art sharing and cultural preservation.
              </p>
            </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-600 mb-4">Join our growing community</p>
