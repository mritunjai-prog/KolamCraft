...
import { 
  User, Settings, Heart, Bookmark, Download, Printer, 
  Edit, Trash2, Eye, Share, Calendar, Grid3x3, Star,
  Trophy, Palette, Clock
} from 'lucide-react';
...
const ProfilePage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Mock user data
    const mockUserDesigns: UserDesign[] = [
      {
        id: '1',
        title: 'My First Kolam',
        imageUrl: 'https://images.unsplash.com/photo-1604374376934-2df6fad6519b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtYW5kYWxhJTIwZ2VvbWV0cmljJTIwcGF0dGVybnN8ZW58MXx8fHwxNzU4NDU1NjczfDA&ixlib=rb-4.1.0&q=80&w=400',
        likes: 34,
        comments: 5,
        isPublic: true,
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1703145219083-6037d97decb5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0cmFkaXRpb25hbCUyMEluZGlhbiUyMGFydCUyMHBhdHRlcm5zfGVufDF8fHx8MTc1ODQ1NTY3Nnww&ixlib=rb-4.1.0&q=80&w=400',
        likes: 78,
        comments: 12,
        isPublic: true,
        gridType: 'Circular',
        ...
        tags: ['diwali', 'festival', 'colorful', 'traditional']
      },
      {
        id: '3',
        title: 'Experimental Pattern',
        imageUrl: 'https://images.unsplash.com/photo-1703583955210-4cca12837223?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb2xvcmZ1bCUyMGdlb21ldHJpYyUyMGFydHxlbnwxfHx8fDE3NTg0NTU2Nzl8MA&ixlib=rb-4.1.0&q=80&w=400',
        likes: 23,
        comments: 3,
        isPublic: true,
        gridType: 'Triangular',
        ...
        tags: ['experimental', 'modern', 'abstract']
      }
    ];
    ...
    const mockSavedDesigns: UserDesign[] = [
      {
        ...
        tags: ['saved', 'inspiration', 'beautiful']
      }
    ];

    setUserDesigns(mockUserDesigns);
  ...
  const stats = {
    ...
    totalComments: userDesigns.reduce((sum, design) => sum + design.comments, 0),
    savedDesigns: savedDesigns.length
  };

  const DesignCard = ({ design, showPrivateActions = false }: { design: UserDesign; showPrivateActions?: boolean }) => (
      ...
      <div className="max-w-7xl mx-auto">
          ...
          <CardContent>
            <div className="grid md:grid-cols-3 gap-4">
              <div className="flex items-center space-x-3 p-3 bg-gradient-to-r from-orange-100 to-pink-100 rounded-lg">
                ...
                <div>
                  <h4>First Design</h4>
                  <p className="text-sm text-gray-600">Created your first Kolam</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3 p-3 bg-gradient-to-r from-green-100 to-blue-100 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Created 3 designs this week</p>
                </div>
              </div>
            </div>
          </CardContent>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="grid w-full grid-cols-3">
            <TabsTrigger value="myPosts">My Posts ({userDesigns.length})</TabsTrigger>
            <TabsTrigger value="private">Private Designs ({privateDesigns.length})</TabsTrigger>
            <TabsTrigger value="saved">Saved Designs ({savedDesigns.length})</TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="myPosts" className="mt-6">
            ...
            {userDesigns.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-4">Create and share your first Kolam design</p>
                <Button onClick={() => navigate('/canvas')}>
                  Start Creating
                </Button>
              </div>
          ...
          <TabsContent value="private" className="mt-6">
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {privateDesigns.map((design) => (
                <DesignCard key={design.id} design={design} showPrivateActions />
              ))}
            </div>
            {privateDesigns.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600">Your draft designs will appear here</p>
              </div>
            )}
          </TabsContent>
          ...
          <TabsContent value="saved" className="mt-6">
            ...
            {savedDesigns.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-4">Designs you save from the community will appear here</p>
